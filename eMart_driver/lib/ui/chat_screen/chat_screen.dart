                      ...
                      Flexible(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            contentPadding: EdgeInsets.only(top: 3, left: 10, right: Directionality.of(context) == TextDirection.RTL ? 0 : 20),
      ...
      child: isMe
          ? Align(
              ...
              child: Column(
                ...
                crossAxisAlignment: Directionality.of(context).toString().contains(TextDirection.RTL.value.toLowerCase()) ? CrossAxisAlignment.start : CrossAxisAlignment.end,
                children: [
