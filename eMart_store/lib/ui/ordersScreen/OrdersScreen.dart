...
class _OrdersScreenState extends State<OrdersScreen> {
            ...
            : StreamBuilder<List<OrderModel>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
                    ...
                    if (snapshot.data!.first.status == ORDER_STATUS_PLACED &&
  ...
  Widget buildOrderItem(
    ...
    for (var element in orderModel.products) {
      print("element.discount_price :: ${element.discount_price}");
      if (double.parse(element.discount_price.trim().isEmpty == true
              ? '0'
    ...
    if (orderModel.adminCommission != '0') {
      if (orderModel.adminCommissionType == 'percentage') {
        double basePrice =
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                    fontSize: 16,
                    color:
                        isDarkMode(context) ? Color(0XFF000000) : Colors.white,
                    letterSpacing: 0.5,
                    fontFamily: 'Poppinsm'),
              ),
            )
                              ...
                              orderModel.takeAway!
                                  ...
                                  : Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'Deliver to: {}'.tr(args: [orderModel.address.getFullAddress()]),
                                            maxLines: 3,
                                            style: TextStyle(
                                                color: isDarkMode(context)
                                                    ? Colors.black
                          ...
                          if (orderModel.adminCommission != '0')
                            Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "(-${amountShow(amount: adminCommission.toString())})",
                                    style: TextStyle(
                                        color: Colors.red,
                                        letterSpacing: 0.5,
                                        fontFamily: 'Poppinssm'),
                        ...
                        children: [
                            ...
                            Expanded(
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (vendorData?.subscriptionTotalOrders ==
                                      '-1') {
                                  ...
                                  if (isSubscriptionActive &&
                                    ...
                                    ShowToastDialog.showToast(
                                        "You have reached the maximum order capacity for your current plan. Upgrade your subscription to continue accepting order seamlessly!"
                                            .tr());
                                    return;
                                  } else {
                            ...
                            Expanded(
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  await FireStoreUtils.getFirestOrderOrNOt(
                                          orderModel)
                                      .then((value) async {
                                    print("isExit----->$value");
                                    if (value == true) {
                            ...
                            Expanded(
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (orderModel.payment_method.toLowerCase() !=
                                      'cod') {
                          ...
                          if (((isSubscriptionModelApplied == true ||
                                      selectedSectionModel
                                              ?.adminCommision?.enable ==
                                          true) &&
                                  (vendorData?.subscriptionPlan?.features
                                              ?.chat ==
                                          true ||
                                      vendorData?.subscriptionPlan?.features
                                              ?.chat ==
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (courierCompanyName.text.isNotEmpty &&
                              trackingId.text.isNotEmpty) {
                            ...
                            await FireStoreUtils.updateOrder(orderModel);
                            if ((isSubscriptionModelApplied == true ||
                                    selectedModel?.adminCommision?.enable ==
                                        true) &&
                                vendorData?.subscriptionPlan != null) {
                              if (vendorData?.subscriptionTotalOrders != '-1' &&
                                  vendorData?.subscriptionTotalOrders != null) {
                                vendorData?.subscriptionTotalOrders =
                                    (int.parse(vendorData
                                                    ?.subscriptionTotalOrders ??
                                                '1') -
...
class PrintTicketState extends State<PrintTicket> {
  ...
  Future<List<int>> getTicket() async {
    ...
    bytes += generator.text(
        'Tel:'.tr() + ' ${widget.orderModel.vendor.phonenumber}',
        styles: const PosStyles(align: PosAlign.center));
  ...
  Future<void> setConnect(BluetoothInfo mac) async {
    ...
    try {
      ...
      PrintBluetoothThermal.connect(macPrinterAddress: mac.macAdress)
          .catchError((error) {
