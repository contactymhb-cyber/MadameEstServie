...
class _AddOrUpdateProductScreenState extends State<AddOrUpdateProductScreen> {
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Visibility(
                              visible: (sectionModel != null &&
                                  sectionModel!.isProductDetails == true),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Padding(
          ...
          onPressed: () async {
            ...
            if (singleImage != null) {
              ...
              String image = await FireStoreUtils.uploadUserImageToFireStorage(
                  ...
                  itemAttributes?.variants?[index].variant_id ?? '');
  ...
  Future<void> _displayTextInputDialog(
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('Attribute values for {}'.tr(args: [title ?? ''])),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                TextField(
                        ...
                        onTap: () {
                          if (_attributesValueController.text.isEmpty) {
                            showAlertDialog(context, 'Error'.tr(),
                                "Please enter attribute value".tr(), true);
                          } else {
                            Navigator.pop(context);
  ...
  submit() async {
    if (rprice.text.isEmpty || int.parse(rprice.text) <= 0) {
      ShowToastDialog.showToast("Please enter valid amount");
    ...
    } else if (int.parse(rprice.text) <= 0) {
      ShowToastDialog.showToast("Please enter valid amount");
    } else {
      if (_key.currentState?.validate() ?? false) {
        ...
        ShowToastDialog.showLoader(widget.product == null
            ? 'Adding product...'.tr()
            : 'Applying edits...'.tr());
        ...
        if (widget.product == null) {
          ...
          productModel.createdAt = widget.product?.createdAt;
        }
