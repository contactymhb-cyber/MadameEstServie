...
class _PhoneNumberInputScreenState extends State<PhoneNumberInputScreen> {
  ...
  String? firstName, lastName, email, _phoneNumber, _verificationID;
                ...
                Visibility(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: InternationalPhoneNumberInput(                        onInputChanged: (PhoneNumber number) => _phoneNumber = number.phoneNumber,
                    ...
                    searchBoxDecoration: InputDecoration(
                      hintText: 'Search by country name or dial code'.tr(),
                    ),
                  ),
                    ),
                  ),
    ...
    try {
      if (_verificationID != null) {
        ...
        dynamic result = await FireStoreUtils.firebaseSubmitPhoneNumberCode(_verificationID!, code, _phoneNumber!,
                email: _emailController.text, firstName: _firstNameController.text, lastName: _lastNameController.text, auto_approve_restaurant: auto_approve_vendor)
        ...
        if (result != null && result is User && result.role == USER_ROLE_VENDOR) {
          ...
          if (widget.login) {
            if (result.active == true) {
              ...
              if (result.section_id.isNotEmpty) {
                ...
                if (result.subscriptionPlanId == null || isExpire(result) == true) {
                  if (selectedSectionModel!.adminCommision!.enable == false && isSubscriptionModelApplied == false) {
      ...
      (auth.PhoneAuthCredential credential) async {
        if (mounted) {
          ...
          if (user != null) {
            ...
            if (user.subscriptionPlanId == null || isExpire(user) == true) {
              if (selectedSectionModel!.adminCommision!.enable == false && isSubscriptionModelApplied == false) {
