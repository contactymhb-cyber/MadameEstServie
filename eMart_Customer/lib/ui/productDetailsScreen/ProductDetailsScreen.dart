...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  getData() async {
    ...
    await FireStoreUtils.getStoreProduct(widget.productModel.vendorID.toString()).then((value) {
      ...
      for (var element in value) {
        if (element.id != widget.productModel.id) {
          if (isSubscriptionModelApplied == true || widget.vendorModel.adminCommission?.enable == true) {
            if (widget.vendorModel.subscriptionPlan != null && isExpire(widget.vendorModel) == false) {
              if (widget.vendorModel.subscriptionPlan?.itemLimit == '-1') {
                storeProductList.add(element);
              } else {
                storeProductList.clear();
                int selectedProduct = value.length < int.parse(widget.vendorModel.subscriptionPlan?.itemLimit ?? '0')
                    ? (value.isEmpty ? 0 : (value.length))
                    : int.parse(widget.vendorModel.subscriptionPlan?.itemLimit ?? '0');
                storeProductList.addAll(value.sublist(0, selectedProduct));
              }
            }
          } else {
            storeProductList.clear();
            storeProductList.addAll(value);
          }
        }
      }
                                  ...
                                  Row(
                                    children: [
                                      widget.productModel.disPrice == "" || widget.productModel.disPrice == "0"
                                          ? Text(
                                              "${amountShow(amount: productCommissionPrice(widget.vendorModel.adminCommission, widget.productModel.price))}",
                                              style: TextStyle(fontSize: 16, letterSpacing: 0.5, color: AppThemeData.primary300),
                                            )
                                          : Row(
                                              children: [
                                                Text(
                                                  "${amountShow(amount: productCommissionPrice(widget.vendorModel.adminCommission, widget.productModel.disPrice.toString()))}",
                                                  style: TextStyle(
                                                    fontSize: 14,
                                        ...
                                        return Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                amountShow(amount: productCommissionPrice(widget.vendorModel.adminCommission, lstAddAddonsCustom[index].price!)),
                                                  ...
                                                  setState(() {
                                                    ...
                                                    if (lstAddAddonsCustom[index].isCheck == true) {
                                                      AddAddonsDemo addAddonsDemo = AddAddonsDemo(
                                                          ...
                                                          price: productCommissionPrice(widget.vendorModel.adminCommission, lstAddAddonsCustom[index].price!));
                                      ...
                                      if (productModel.itemAttributes != null) {
                                        ...
                                        if (productModel.itemAttributes!.variants!.where((element) => element.variant_sku == selectedVariants.join('-')).isNotEmpty) {
                                          price = productCommissionPrice(
                                              widget.vendorModel.adminCommission,
                                              productModel.itemAttributes!.variants!.where((element) => element.variant_sku == selectedVariants.join('-')).first.variant_price ??
                                                  '0');
                                          disPrice = productCommissionPrice(widget.vendorModel.adminCommission, '0');
                                        }
                                      } else {
                                        price = productCommissionPrice(widget.vendorModel.adminCommission, productModel.price);
                                        disPrice = productCommissionPrice(widget.vendorModel.adminCommission, productModel.disPrice.toString());
                                      }
                                      return Container(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        disPrice == "" || disPrice == productCommissionPrice(widget.vendorModel.adminCommission, '0')
                                                            ? Text(
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      disPrice == "" || disPrice == "0" || disPrice == productCommissionPrice(widget.vendorModel.adminCommission, '0')
                                                          ? Text(
                                                              "${amountShow(amount: price)}",
                                                              style: TextStyle(letterSpacing: 0.5, color: AppThemeData.primary300),
                                                            )
  ...
  addtocard(ProductModel productModel, bool isIncerementQuantity) async {
    ...
    for (int i = 0; i < lstTemp.length; i++) {
      ...
      if (addAddonsDemo.categoryID == widget.productModel.id) {
        isAddOnApplied = true;
        AddOnVal = AddOnVal + double.parse(productCommissionPrice(widget.vendorModel.adminCommission, addAddonsDemo.price!));
      }
    }
    ...
    if (productQnt > 1) {
      ...
      if (cartProducts.isEmpty) {
        cartDatabase.addProduct(productModel, cartDatabase, isIncerementQuantity, widget.vendorModel);
      } else {
