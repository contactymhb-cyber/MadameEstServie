                ...
                GestureDetector(
                  onTap: () {
                    ...
                    if ((isSubscriptionModelApplied == true ||
                            vendorModel!.adminCommission?.enable == true) &&
                        vendorModel!.subscriptionPlan != null) {
                      if (vendorModel?.subscriptionTotalOrders == '0' ||
                          vendorModel?.subscriptionTotalOrders == null) {
                        ShowToastDialog.closeLoader();
                        ShowToastDialog.showToast(
                            "This vendor has reached their maximum order capacity. Please select a different vendor or try again later.".tr());
                        return;
                      }
                    }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 20, color: AppThemeData.primary300),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        selctedOrderTypeValue == "Delivery"
                        // CAS 1 CORRIGÉ :
                            ? 'deliveryWithAmount'.tr(args: [amountShow(amount: deliveryCharges.toString())])
                        // CAS 2 CORRIGÉ :
                            : 'orderTypeFree'.tr(args: [selctedOrderTypeValue!.tr()]),
