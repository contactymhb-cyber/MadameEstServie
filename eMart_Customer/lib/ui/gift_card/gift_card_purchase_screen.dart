...
class _GiftCardPurchaseScreenState extends State<GiftCardPurchaseScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Complete purchase".tr(), style: TextStyle(color: AppThemeData.primary300, fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: false,
      ),
      body: Padding(
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Text("Complete payment and share this e-gift card with loved ones using any app.".tr()),
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("BILL SUMMARY".toUpperCase().tr(),
              ...
              Text(
                'giftCardExpiryInfo'.tr(args: [giftCardModel.expiryDay.toString()]),
