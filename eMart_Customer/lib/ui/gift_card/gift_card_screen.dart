...
class _GiftCardScreenState extends State<GiftCardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Customize Gift Card".tr(), style: TextStyle(color: AppThemeData.primary300, fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: false,
        actions: [
          InkWell(
              onTap: () {
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Swap to choose card".tr(),
                      ...
                      child: Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text("Choose amount".tr().toUpperCase(),
                                ...
                                ? Row(
                                    children: [
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Center(child: Text("Custom".tr())),
                                            ),
                                          ),
                                        ),
                                      ),
                                      ...
                                      InkWell(
                                          ...
                                          child: Text("Add".tr(), style: TextStyle(color: AppThemeData.primary300))),
                                    ],
                                  )
                                : Container(
                                    height: 60,
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 18),
                            child: Text("Add Message (Optional)".tr().toUpperCase(),
            ...
            onPressed: () {
              if (selectedAmount.isNotEmpty && selectedAmount != "Custom") {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text("Please Add Amount".tr()),
